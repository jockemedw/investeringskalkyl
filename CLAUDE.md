...
- [x] **Nav-knappar klickbara (2026-07-10, ddfafef):** hyperlänk PÅ knapp-PNG:erna via `patch_nav_hyperlinks` (post_save-XML: hlinkClick i cNvPr + drawing-rels). Cell-länkarna bakom nås aldrig med mus och bilder är döda på skyddade blad. OBS openpyxl skriver drawing-XML utan xdr:-prefix och insatta element måste deklarera xmlns inline — annars reparerar Excel tyst bort dem vid recalc. Verifierat: 100/100 länkar efter recalc + COM Follow 10/10.
